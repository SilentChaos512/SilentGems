...
public class GeodeGenerator extends WorldGenMinable {
  ...
  public void generateShell(World worldIn, Random rand, BlockPos position, float diameterXZ,
      float diameterY) {
  ...
  public void generateGems(World worldIn, Random rand, BlockPos position, float diameterXZ,
      float diameterY) {
