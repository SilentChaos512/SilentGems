package net.silentchaos512.gems.control;
...
public class PlayerInputMap {
    ...
    public boolean equals(Object obj) {
        ...
        try {
            ...
            return other.forwardKey == forwardKey && other.strafeKey == this.strafeKey && other.jumpKey == this.jumpKey
                    && other.sneakKey == this.sneakKey && other.downKey == this.downKey && other.motionX == this.motionX
                    && other.motionY == this.motionY && other.motionZ == this.motionZ;
        }
