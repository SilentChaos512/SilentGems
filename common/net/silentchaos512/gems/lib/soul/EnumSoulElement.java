...
public enum EnumSoulElement {
  ...
  FIRE(     13,  0.00f,  0.00f, +0.15f,  0.00f, -0.10f),
  WATER(    12,  0.00f,  0.00f, -0.10f, +0.15f,  0.00f),
  EARTH(    11, +0.15f,  0.00f,  0.00f, -0.10f,  0.00f),
  WIND(     10,  0.00f, +0.10f, -0.10f,  0.00f,  0.00f),
  METAL(    18, +0.20f,  0.00f,  0.00f, -0.20f, +0.10f),
  ICE(      17, -0.10f,  0.00f,  0.00f, +0.20f, -0.10f),
  LIGHTNING(16, -0.20f, +0.10f, +0.10f, +0.10f, -0.10f),
  VENOM(    15, +0.10f, -0.20f, +0.15f,  0.00f,  0.00f),
  FLORA(     5, -0.10f,  0.00f, -0.10f, +0.10f,  0.00f),
  FAUNA(     6,  0.00f,  0.00f, +0.10f, -0.10f, -0.10f),
  MONSTER(   7, +0.10f, -0.10f,  0.00f, -0.10f,  0.00f),
