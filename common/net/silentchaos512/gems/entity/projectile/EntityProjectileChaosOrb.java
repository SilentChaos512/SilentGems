...
public class EntityProjectileChaosOrb extends EntityThrowable
  ...
  public void onUpdate() {
    ...
    MovingObjectPosition mop = worldObj.rayTraceBlocks(vec1, vec2, false, true, false);
    if (mop != null) {
      onImpact(mop);
    }
  ...
  protected void onImpact(MovingObjectPosition mop) {
    ...
    if (mop.typeOfHit == MovingObjectType.ENTITY && mop.entityHit != shootingEntity) {
      ...
      AxisAlignedBB boundingBox = block.getCollisionBoundingBox(worldObj, pos, state);
  ...
  public void writeEntityToNBT(NBTTagCompound tags) {
    ...
    if (shootingEntity != null) {
      tags.setString(TAG_SHOOTER, shootingEntity.getName());
    }
  }
