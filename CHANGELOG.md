...
## [3.7.16] - 2021-06-15
### Added
- Config to blacklist glowrose world generation by dimension ID [#512]
### Changed
- Gear souls can no longer gain the unimplemented traits Chill, Warm, and Coffee Pot
### Fixed
- Replaced the broken glowrose world gen configs with a new one that actually works (`glowrose.world.patchCount`) [#536]
- Treasure Bags support updated for version 1.3.2+

## [3.7.15] - 2021-05-04
### Added
- Config to set the seed value used to determine soul gem elements. If left empty, it uses the world seed instead. [#538]

## [3.7.14] - 2021-04-03
### Added
- Patchouli guide book (ClaudiusMinimus) [#532]
### Fixed
- Treasure Bags support updated for version 1.3.1
...
## [3.7.11] - 2021-02-20
### Fixed
- Gear souls not giving stat bonuses (may require Silent Gear 2.6.3)

## [3.7.10] - 2021-02-13
### Added
- Russian translation (shikhtv) [#527]
### Fixed
- Missing lang keys for some materials [#528]

## [3.7.9] - 2021-01-15
### Fixed
- Supercharged materials not functioning correctly [#523]
...
- Gear souls missing stats with Silent Gear 2.4.10
