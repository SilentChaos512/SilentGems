...
- Soul gem ingredient for use in recipes. This allows vanilla shaped/shapeless recipes to require a soul gem of a specific entity. See the wiki for details if you want to take advantage of this (politely yell at me on Discord if I have forgotten to write the wiki page).
