...
/**
 * An item that stores Chaos. Nodes and Pylons sending Chaos to players will fill IChaosStorage
 * items.
 *
...
public interface IChaosStorage {
     ...
     * @param simulate   If true, the Chaos will not actually be extracted.
