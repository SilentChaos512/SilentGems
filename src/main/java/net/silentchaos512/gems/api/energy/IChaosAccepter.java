...
/**
 * Represents a tile entity that can receive Chaos energy. Certain tiles like Nodes and Pylons will
 * try to send their Chaos to Accepters.
 *
...
public interface IChaosAccepter extends IChaosHandler {
     ...
     *
     * @param maxReceive The maximum amount to send to the Accepter.
     * @param simulate   If true, the Chaos will not actually be received.
