...
public class ParticleCompass extends ParticleSL {
    ...
    public ParticleCompass(World world, double posX, double posY, double posZ, double motionX, double motionY, double motionZ) {
        this(world, posX, posY, posZ, motionX, motionY, motionZ, MAX_SCALE, MAX_AGE, 0.0f, 0.3f, 0.8f);
    }

    public ParticleCompass(World world, double posX, double posY, double posZ, double motionX, double motionY, double motionZ, float scale, int maxAge, float red, float green, float blue) {
...
//    this.particleAlpha -= 0.8f / (particleMaxAge * 1.25f);
    ...
    @Override
    public void clRenderParticle(BufferBuilderSL worldRendererIn, Entity entityIn, float partialTicks, float rotationX, float rotationZ, float rotationYZ, float rotationXY, float rotationXZ) {
