...
//            RecipeChaosAltar recipe = recipeIndex >= 0 && recipeIndex < RecipeChaosAltar.ALL_RECIPES.size()
//                    ? RecipeChaosAltar.ALL_RECIPES.get(recipeIndex)
//                    : null;
//
//            String format = "%s: %,d / %,d";
//            // Chaos stored
////            this.fontRenderer.drawString(String.format(format, "Chaos", tileAltar.getCharge(),
////                    tileAltar.getMaxCharge()), 8, 6, 0x404040);
//
//            // Transmute progress
...
//
//            // Recipe info
//            this.fontRenderer.drawString("Recipe: " + recipeIndex + (recipe == null ? "" : " ("
//                            + recipe.getOutput().getDisplayName() + ")"), 8, 26, 0x404040);
//        }
    }
