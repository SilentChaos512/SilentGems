...
public class RecipeMixedMaterialItem extends RecipeBaseSL {
    ...
    public RecipeMixedMaterialItem(@Nullable EnumMaterialTier tierRestriction, Item toolOrArmorItem, Object... recipe) {
        ...
        this.shapedRecipe = new ShapedRecipes(SilentGems.MODID, recipeWidth, recipeHeight, ingredients, new ItemStack(toolOrArmorItem));
    }
    ...
    private ItemStack getFrame(InventoryCrafting inv) {
    ...
    private boolean doesFrameMatchItem(ArmorPartFrame frame) {
