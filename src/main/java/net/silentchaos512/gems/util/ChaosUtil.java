...
public class ChaosUtil {
     ...
     *
     * @param world
     * @param center           The location of the sender.
     * @param horizontalRadius The maximum number of blocks to look out of the x- and z-axis.
     * @param verticalRadius   The maximum number of blocks to look up/down on the y-axis.
     * @return List of reachable accepters.
     */
    public static List<IChaosAccepter> getNearbyAccepters(World world, final BlockPos center, final int horizontalRadius, final int verticalRadius) {
    ...
    /**
     * Determine if the target position can be "seen" from the source position. Ignores liquids and
    ...
    /**
     * Determines if the target entity can be "seen" from the source position. Ignores liquids and
     * blocks with no collision.
     *
     * @return True if there is a clear line of sight, false otherwise.
     */
    ...
    /**
     * Gets the amount of chaos the player could receive, include available capacity in items that
     * store chaos.
     */
    ...
    /**
     * Send chaos to a tile entity. Replaces the old packet spawning methods. Also spawns
     * particles.
     *
