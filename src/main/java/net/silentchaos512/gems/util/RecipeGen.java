...
import net.silentchaos512.lib.util.RecipeGenerator;
import net.silentchaos512.lib.util.RecipeGenerator.ShapedBuilder;
import net.silentchaos512.lib.util.RecipeGenerator.ShapelessBuilder;
import net.silentchaos512.lib.util.RecipeGenerator.SmeltingBuilder;

/**
 * Generates recipe JSON files. This does not add the recipes in-game. The files need to be copied
 * to the correct directory for them to load. This end up in 'run/output'.
 */
public class RecipeGen {
    public static void generateRecipes() {
        for (Gems gem : Gems.values()) {
            // Block <--> Gem
            RecipeGenerator.compress9(name(gem.getName() + "_block"), gem.getBlock(), gem.getItem());
            // Gem <--> Shard
            RecipeGenerator.compress9(name(gem.getName()), gem.getItem(), gem.getShard());
            // Bricks
