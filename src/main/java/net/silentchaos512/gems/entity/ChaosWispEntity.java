...
public class ChaosWispEntity extends AbstractWispEntity {
    public ChaosWispEntity(EntityType<? extends MonsterEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    protected AbstractWispShotEntity getProjectile(AbstractWispEntity wisp, double accelX, double accelY, double accelZ) {
        return new ChaosWispShotEntity(WispTypes.CHAOS.getShotType(), wisp, accelX, accelY, accelZ, wisp.world);
    }
}
