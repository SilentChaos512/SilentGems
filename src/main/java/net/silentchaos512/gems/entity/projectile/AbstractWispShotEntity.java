...
public abstract class AbstractWispShotEntity extends DamagingProjectileEntity implements IEntityAdditionalSpawnData {
    ...
    public AbstractWispShotEntity(EntityType<? extends AbstractWispShotEntity> typeIn, World worldIn) {
        super(typeIn, worldIn);
    }

    public AbstractWispShotEntity(EntityType<? extends AbstractWispShotEntity> typeIn, double posXIn, double posYIn, double posZIn, double accelX, double accelY, double accelZ, World worldIn) {
