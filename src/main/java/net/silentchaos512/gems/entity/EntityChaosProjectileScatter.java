...
public class EntityChaosProjectileScatter extends EntityChaosProjectile {
    ...
    /**
     * The scatter shot is intended to hit the same entity with multiple shots on the same frame.
     * Instead of damage the entity multiple times in one frame, this class adds up the damage then
     * applies it at the end of the server tick. Ghast screams are unpleasant enough without playing
     * them 8 times at once...
     */
