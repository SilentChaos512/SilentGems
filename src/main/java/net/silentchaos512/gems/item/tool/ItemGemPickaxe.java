...
public class ItemGemPickaxe extends ItemPickaxe implements ITool, IAddRecipes, ICustomModel {
    ...
    public void getSubItems(CreativeTabs tab, NonNullList<ItemStack> items) {
        ...
        items.addAll(ToolHelper.getSubItems(this, 3));
    }
