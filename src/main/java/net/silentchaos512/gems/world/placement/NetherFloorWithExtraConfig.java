...
public class NetherFloorWithExtraConfig extends AtSurfaceWithExtraConfig {
    public static final Codec<net.silentchaos512.gear.world.placement.NetherFloorWithExtraConfig> CODEC = RecordCodecBuilder.create(instance ->
            instance.group(
            ...
            ).apply(instance, net.silentchaos512.gear.world.placement.NetherFloorWithExtraConfig::new));
