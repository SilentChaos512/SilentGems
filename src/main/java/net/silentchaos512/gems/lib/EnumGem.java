...
public enum EnumGem implements IStringSerializable {
    ...
    PERIDOT         ("Peridot",         384,  6.0f, 4.0f, 3.0f, 0.7f, 14, 14, 3.0f, 0xA3E61D, "gemOlivine"),
    BERYL           ("Beryl",           512,  9.0f, 4.0f, 2.0f, 1.1f, 14, 16, 2.0f, 0x1DE61D, "gemGreenSapphire"),
    ...
    IOLITE          ("Iolite",          512,  6.0f, 2.0f, 4.0f, 1.0f, 20, 11, 2.0f, 0x601DE6, "gemCordierite"),
    ...
    // deprecated (all in block) - remove in 1.13
    ...
    // deprecated - remove in 1.13
    private static final String STR_SUPER = "Super";

    // stat fields deprecated - remove in 1.13
    ...
    EnumGem(String name, int durability, float miningSpeed, float meleeDamage, float magicDamage, float meleeSpeed, int protection, int enchantability, float chargeSpeed, int color, String... extraOreKeys) {
        this.name = name;
    ...
    // ===========================
    // Tier-sensitive stat getters (deprecated - remove in 1.13)
    // ===========================
