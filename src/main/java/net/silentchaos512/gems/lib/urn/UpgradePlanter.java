...
public class UpgradePlanter extends UrnUpgrade {
    private static final int TICK_FREQUENCY = TimeHelper.ticksFromSeconds(30);
    private static final Map<Item, Plant> PLANTS = new HashMap<>();
    ...
    public static void init() {
        ...
        PLANTS.put(Items.MELON_SEEDS, new Plant(1, random -> dropsWithChance(random,
                new ItemStack(Items.MELON, random.nextInt(4) + 1), 0.85,
                new ItemStack(Blocks.MELON_BLOCK), 0.2)));
        ...
        PLANTS.put(Items.PUMPKIN_SEEDS, new Plant(1, random -> dropsWithChance(random,
                ...
                new ItemStack(Blocks.LIT_PUMPKIN), 0.01)));
        PLANTS.put(Items.REEDS, new Plant(1, random -> dropsWithChance(random,
                new ItemStack(Items.REEDS, random.nextInt(2) + 1), 0.85)));
