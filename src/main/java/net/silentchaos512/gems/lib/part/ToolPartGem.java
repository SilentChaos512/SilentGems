...
public class ToolPartGem extends ToolPartMain {
    ...
    public String getDisplayName(ItemStack stack) {
        ...
        return SilentGems.i18n.translate("item", Names.GEM + stack.getItemDamage() + ".name");
    }

    @Override
    public String getDisplayNamePrefix(ItemStack stack) {
        return tier == EnumMaterialTier.SUPER ? SilentGems.i18n.itemSubText(Names.GEM, "superPrefix") : "";
    }
